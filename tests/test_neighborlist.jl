...
@testset "KIM Neighbors Tests" begin
    ...
    @testset "create_neighborlist_closure" begin
        ...
        @test_throws ArgumentError KIM.create_neighborlist_closure(
            positions,
            cutoff,
            nothing,
            [true, true, true],
    ...
    @testset "kim_neighbors_function" begin
        ...
        nl_containers = KIM.create_kim_neighborlist_dataobject(
            positions,
            cutoffs,
            cell,
            [false, false, false],
    ...
    @testset "Index conversion" begin
        ...
        get_neighbors =
            KIM.create_neighborlist_closure(positions, cutoff, cell, [false, false, false])
